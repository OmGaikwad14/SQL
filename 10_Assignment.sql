...
VALUES ('VIshal', 'Babar', 'IT', 60000.00, '2022-05-01', 29),
		('Omkar', 'Ghule', 'HR', 55000.00, '2021-08-15', 32),
		('Onkar', 'Kale', 'Finance', 70000.00, '2020-03-10', 35),
		('Aditi', 'Sadavarte', 'IT', 65000.00, '2019-11-22', 28),
		('Shubham', 'Talekar', 'Operations', 50000.00, '2023-01-10', 26);
